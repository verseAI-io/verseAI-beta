...
export default function SQLInterviewV3({ onBackToHome }) {
      ...
      case 'results':
        return (
          <div style={{ height: '100%', overflowY: 'auto', padding: '10px' }}>
            {!queryResults && !error && (
              <div style={{ opacity: 0.5, textAlign: 'center', padding: '30px', fontSize: '13px' }}>
                Click "Run Query" to see results
              </div>
            )}
            {error && (
              <div style={{ background: 'rgba(255, 0, 0, 0.2)', border: '2px solid #ff0000', borderRadius: '5px', padding: '15px', color: '#ff6b6b' }}>
                    ...
                    {queryResults.map((row, idx) => (
                      <tr key={idx} style={{ background: idx % 2 === 0 ? 'rgba(0, 191, 255, 0.05)' : 'transparent' }}>
                        {Object.values(row).map((value, colIdx) => (
                          <td key={colIdx} style={{ padding: '6px 8px', borderBottom: '1px solid rgba(0, 191, 255, 0.2)' }}>
            ...
            {queryMetadata && (
              <div>
                <div style={{
                  ...
                  <div style={{ fontSize: '10px', opacity: 0.7, marginBottom: '5px', textTransform: 'uppercase' }}>
                    Time
                  </div>
                  <div style={{ fontSize: '13px', fontWeight: 'bold' }}>
                    {queryMetadata.executionTime}ms
                  </div>
                </div>
                <div style={{
                  background: 'rgba(0, 191, 255, 0.1)',
          ...
          <div style={{
            ...
            <div style={{ flex: 1, textAlign: 'center' }}>
              <h1 style={{
                ...
                <span style={{ color: '#00bfff' }}>VERSE</span>AI INTERVIEW PREP V3
              </h1>
              <p style={{
                fontSize: '14px',
                opacity: 0.7,
